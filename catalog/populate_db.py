...
item_1 = Item(title="Soccer Ball", desc=desc_1, cat_id=1, user_id=1)
...
item_2 = Item(title="Cleats", desc=desc_2, cat_id=1, user_id=1)
...
item_3 = Item(title="Racket", desc=desc_3, cat_id=2, user_id=1)
...
item_4 = Item(title="Tennis Ball", desc=desc_4, cat_id=2, user_id=1)
...
item_5 = Item(title="Snowboard", desc=desc_5, cat_id=3, user_id=1)
